package by.bsu.entity.human;

import by.bsu.logic.observer.Observable;
...
public class Student extends Human implements Observable {
    ...
    public String getReasonOfEvict() {
        if (!payment) {
            return "payment";
        } else {
            return comments > COMMENTS_FOR_REMOVE ? "comments" : "4th course";
        }
    }
